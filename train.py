...
def test():
    ...
    if os.path.exists('/content/AML_project/outputs/triplet_match/BEST_checkpoint.pth'):
        model.load_state_dict(torch.load('/content/AML_project/outputs/triplet_match/BEST_checkpoint.pth'), strict=False)
